...
import json
with open('src/rndNetConf.json', 'w') as f:
...
# grapgh JSON to sequence network
network_config = "src/netconf_sample.json"
...
nm.request(start_node_name, start_time=1e12, end_time=10e12,
