...
def old_test(sim_time, keysize):
    ...
    cc0 = ClassicalChannel("cc_n0_n1", tl, distance=1e3, delay=1e9)
    cc1 = ClassicalChannel("cc_n1_n0", tl, distance=1e3, delay=1e9)

    cc2 = ClassicalChannel("cc_n2_n0", tl, distance=1e3, delay=1e9)
    cc3 = ClassicalChannel("cc_n0_n2", tl, distance=1e3, delay=1e9)

    cc4 = ClassicalChannel("cc_n1_n2", tl, distance=1e3, delay=1e9)
    cc5 = ClassicalChannel("cc_n2_n1", tl, distance=1e3, delay=1e9)
    ...
    senderp = SenderProtocol(n0, "senderp", "receiverp", "n1")
    receiverp = ReceiverProtocol(n1, "receiverp", "senderp","n0")
